        ...
        <form action="{{ route('afiliados.update', $afiliado) }}" method="POST" class="bg-surface-container-lowest p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $afiliado->fecha_nacimiento?->format('Y-m-d')) }}" class="w-full bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary p-3">
                ...
                <div>
                    ...
                    <input type="text" name="numero_solicitud" value="{{ old('numero_solicitud', $afiliado->numero_solicitud) }}" class="w-full bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary p-3">
                ...
                <div>
                    ...
                    <input type="number" min="0" name="cantidad_dependientes" value="{{ old('cantidad_dependientes', $afiliado->cantidad_dependientes) }}" class="w-full bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary p-3">
